...
class AESTest {
    ...
    void polynomialMultiplicationTest() {
        assertEquals(1, (aes.polynomialMultiplication((byte) 1, (byte) 1)));
        assertEquals(0, (aes.polynomialMultiplication((byte) 0, (byte) 0)));
        assertEquals(0b110011, aes.polynomialMultiplication((byte) 0b110011, (byte) 1));
    }

    @Test
    void polynomialDivisionTest() {
        assertEquals(0b1, aes.polynomialModuloDivision(0b1));
        assertEquals(0b10, aes.polynomialModuloDivision(0b10));
        assertEquals(0b100, aes.polynomialModuloDivision(0b100));
    }

    @Test
    void convertStringToByteArrayTest() {
        assertArrayEquals(new byte[]{1, 16}, aes.hexStringToByteArray("0110"));
    }
